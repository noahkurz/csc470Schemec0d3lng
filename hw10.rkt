...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname hw10) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;(do-math(math-exp (var-exp 12) / (lit-exp 2)))
