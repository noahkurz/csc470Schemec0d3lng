...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname HW15) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
(define sendMessage
  (lambda(object param)
    (cond
      ...
      (else(searchMethod(objLookDeeperChild(obj->parent object)param))))))
(define searchMethod
